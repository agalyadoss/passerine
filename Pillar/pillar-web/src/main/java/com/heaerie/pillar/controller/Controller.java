...
import com.heaerie.pillar.service.AuthService;
import com.heaerie.pillar.service.AuthToken;
import com.heaerie.pillar.service.PillarBadFormatException;
import com.heaerie.pillar.service.PillarInternalServerError;
...
public abstract class Controller<I, M extends Mapper<I>> {
    ...
    public abstract void validate() throws PillarBadFormatException;
    ...
    public Response get() {
        try {
            prepareToken();
            validate();
        } catch (PillarBadFormatException e) {
